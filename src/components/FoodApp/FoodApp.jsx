...
export const Foodapp = (props) => {
  ...
  return (
    <section className='md:mt-[115px]'>
      <div className="w-[100%] bg-[#FAFAFA]" id='home'>
        <div className='w-0 h-0 md:w-[100%] md:h-[100%]'>
          <img src={BackgroundFoodApp} alt="" className='md:w-[100%] md:h-[619px] md:z-[-1]' />
        </div>
        <div className="text-center md:z-10 md:mt-[-602px] ">
          <h5 className='flex-none font-montserrat pt-[50px] track-[0.1px] font-bold text-[16px] 
          leading-[24px] not-italic text-[#737373] grow-0 order-0 
          md:font-bold md:text-[24px] md:leading-9 md:text-[#F7F7F7]'>
            Food app
          </h5>
        </div>
        <div className="text-center mx-[11.5px] pt-[17px] md:z-10">
        ...
        <div className="md:flex md:justify-center mx-[36px] text-center pt-[27px] pb-[50px] md:z-10 ">
        ...
        <div className='md:flex md:flex-row md:justify-center md:gap-4 flex flex-col items-center gap-4 '>
            <button className='md:z-20 bg-[#FA4A0C] md:hover:bg-orange-300 w-[236px] py-4 px-[58.5px] rounded-[30px] text-white'>
